...
// Necessary imports
import amendoza123_project2.TonyoStack;
 ...
 *
 * 1. Implement and use Stack class and methods: Program uses "Push", "Peek". I
 * couldn't find a use a good reason to use 'Pop'. 2. Use a separate class to
 * represent Objects for Stack: Done 3. Write additional methods to search
 * through a Stack: Done externally. Parameters for searching are too specific
 * for a TonyoStack class. 4. Use methods to do separate and repetitive work.
 * The main method should not have more than 20 lines of code: Done. 12/20. 5.
 * Implement the project correctly: Works like awesome. Bonus: 10 points will be
 * awarded for use of meaningful identiﬁers, consistent indentation, explanatory
 * comments in your code and properly formatted output.: Done. Done. Done.
 */
public class Project2 {

    // This TonyoStack is the backbone of the application. It stores accounts storing other TonoyStacks!
    static TonyoStack<Player> accounts;
    ...
    static Player activeAccount; // This is used as a pointer to reference the current session's account
    ...
    static void ProcessInput(Scanner input, TonyoStack<Account> accounts) throws IOException {
        ...
        do {
            ...
            if (activeAccount == null) { // If there is no active account.
                System.out.println("\t=> [1] Play Game"); // Option [1] registers the client.
                System.out.println("\t=> [2] Display Leaderboard"); // Option [2] logs out the client.
                System.out.println("\t=> [3] Search Scores"); // Option [3] logs a call.
                System.out.println("\t=> [4] Delete Scores"); // Option [4] displays call history.
                //System.out.println("\t=> [5] Display Shortest and Longest Calls"); // Op tion [5] displays the shortest and longest call.
            }
            System.out.println("\t=> [5] Quit Game"); // Option [6] shuts the program down.
            ...
            if (command.equals("1")) {
                ...
                DisplayLeaderboardProcess(input);
